...
class WonderPlugin_Slider_View {
	...
	function print_overview() {
		...
		<h2><?php echo __( 'WonderPlugin Slider', 'wonderplugin_slider' ) . ( (WONDERPLUGIN_SLIDER_VERSION_TYPE == "C") ? " Commercial Version" : " Commercial Version") . " " . WONDERPLUGIN_SLIDER_VERSION; ?> </h2>
